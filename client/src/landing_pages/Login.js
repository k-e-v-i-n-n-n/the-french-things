...
const Login = () => {
    ...
    let condPassword = isSignup ? "" : "password"
    let condUser = isSignup ? "" : "user"
    const [username, setUsername] = useState(condUser)
    const [password, setPassword] = useState(condPassword)
